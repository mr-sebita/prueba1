...
/*El tech leader de tu equipo de desarrollo propone refactorizar la app de tareas. Para esto te
encargamos:

1. Modificar la funcionalidad de listar tareas. Deberás utilizar el método forEach.
Recordá que forEach puede recibir dos parámetros, siendo el segundo nuestro
index, es posible que tengas que usarlo.*/
...
switch (accion) {
    case 'listar':
        ...
        tareas.forEach(tareas.titulo, tareas.estatus => {
            console.log(i + '. ' + tareas.titulo + ' - ' + tareas.estado);
